...
def batch_process_images(
    ...
    **kwargs
    ...
    if recursive:
        # Process recursively maintaining directory structure
        return _process_recursive(input_dir, output_dir, remover_instance, **kwargs)
    
    # Process all supported images in directory (original behavior)
...
def _process_recursive(input_dir: str, output_dir: str, remover_instance, **kwargs) -> List[dict]:
    """
    Process images recursively maintaining directory structure.
    ...
    for root, dirs, files in os.walk(input_dir):
        ...
        for file in files:
            ...
            try:
                ...
                final_output_path = output_path / relative_path.parent / output_name
                ...
                # Process image
                success = remover_instance.remove_background(
                    str(file_path), 
                ...
                results.append({
                    'input_file': str(relative_path),
                    'output_file': str(final_output_path.relative_to(output_path)),
